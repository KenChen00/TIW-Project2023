...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2023-03-13 08:57:23',NULL),('diagnostics.include_raw','OFF','2023-03-13 08:57:23',NULL),('ps_thread_trx_info.max_length','65535','2023-03-13 08:57:23',NULL),('statement_performance_analyzer.limit','100','2023-03-13 08:57:23',NULL),('statement_performance_analyzer.view',NULL,'2023-03-13 08:57:23',NULL),('statement_truncate_len','64','2023-03-13 08:57:23',NULL);
...
--
-- Current Database: `Web100`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `Web100` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `apply` (
  ...
  `code_seller` varchar(45) NOT NULL,
  `id_range` varchar(45) NOT NULL,
  PRIMARY KEY (`code_order`,`code_seller`,`id_range`),
  KEY `ApplySeller_idx` (`code_seller`),
  KEY `ApplyRange_idx` (`id_range`),
  CONSTRAINT `ApplyOrder` FOREIGN KEY (`code_order`) REFERENCES `Order` (`code`),
  CONSTRAINT `ApplyRange` FOREIGN KEY (`id_range`) REFERENCES `SpendingRange` (`id`),
  CONSTRAINT `ApplySeller` FOREIGN KEY (`code_seller`) REFERENCES `Seller` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Card` (
  ...
  `cvv` int NOT NULL,
  PRIMARY KEY (`number`),
  KEY `UserCard_idx` (`email_user`),
  CONSTRAINT `UserCard` FOREIGN KEY (`email_user`) REFERENCES `User` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Card` VALUES ('111','leo@mail.com','2030-01-01',1),('222','leo@mail.com','2035-01-01',2),('999','ken@mail.com','2030-12-12',999);
...
CREATE TABLE `compose` (
  ...
  KEY `composeProduct_idx` (`code_product`),
  CONSTRAINT `composeOrder` FOREIGN KEY (`code_order`) REFERENCES `Order` (`code`),
  CONSTRAINT `composeProduct` FOREIGN KEY (`code_product`) REFERENCES `Product` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Order` (
  ...
  `email_user` varchar(45) NOT NULL,
  PRIMARY KEY (`code`),
  KEY `user_idx` (`email_user`),
  CONSTRAINT `UserOrder` FOREIGN KEY (`email_user`) REFERENCES `User` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Product` VALUES ('P001','Bic Blue Pen ',0.5,'stationary','p001','high quality pen witch can write something awesome'),('P002','Lavazza Classic',72.99,'foods','p002','the caffè is since 1956'),('P003','Samsung Galaxy S22 Ultra 12GB RAM, 512GB SSD',1489,'smartphones','p003','the smartphone is fastest to charge'),('P004','Lobyoh Music carpet with 8 animals',21.99,'toys','p004','your children can dance with it'),('P005','Samsung Microwave MC28H5015AS/ET',178.2,'home appliances','p005','the color is gray and is useful'),('P006','Disney La Sirenetta Ariel doll',22.99,'toys','p006','adorable toy'),('P007','Orsen WriteBoard',19.99,'toys','p007','for the children since 3 years old'),('P008','Lavazza Mio Orzo',33.74,'foods','p008','the caffè is since 1965'),('P009','Educa Puzzle Disney 500 pices',8.99,'toys','p009','misure is 34 X 48 cm'),('P010','Yomo Yogurt',3.38,'foods','p010','with 8 taste: straberry, banana, blueberry... '),('P011','ZINUS mattress cooling essential',65.99,'bedrooms','p011',NULL),('P012','Huawei MateBook 16s Laptop, Display Touchscreen Core i7-12700H',1499.99,'computers','p012','RAM 16GB DDR5, ROM 1TB SSD, Windows 11, Space Gray'),('P013','ZINUS Jackie sofa',300.66,'bedrooms','p013',NULL),('P014','Caffè Alloia',25.4,'foods','p014','this coffee is delicious'),('P016','Hisense refrigeratorMTM55206F',259,'home appliances','p016','the refrigerator\'s color is white, and it\'s resistible'),('P017','ZINUS Mikhail sofa',209.99,'bedrooms','p017','red, 2 positions'),('P018','Apple iPhone 14 Pro (512GB)',17299,'smartphones','p018','Beyond'),('P023','2015 Apple iPad Pro (12,9 inch, Wifi, 32GB,gray)',499.88,'tablets','p023','is excellent product'),('P026','Coca Coke Original Taste',21.13,'foods','p026','12 bottle * 350 ml'),('P038','Barilla Pasta Penne ',1.15,'home appliances','p038','rollable, 2 positions');
...
CREATE TABLE `sell` (
  `code_product` varchar(45) NOT NULL,
  `code_seller` varchar(45) NOT NULL,
  PRIMARY KEY (`code_product`,`code_seller`),
  KEY `sellSeller_idx` (`code_seller`),
  CONSTRAINT `sellProduct` FOREIGN KEY (`code_product`) REFERENCES `Product` (`code`),
  CONSTRAINT `sellSeller` FOREIGN KEY (`code_seller`) REFERENCES `Seller` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sell` VALUES ('P001','S001'),('P026','S002'),('P009','S003'),('P010','S004'),('P002','S005'),('P008','S005'),('P004','S006'),('P016','S010'),('P006','S012'),('P011','S013'),('P013','S013'),('P017','S013'),('P038','S021'),('P018','S066'),('P023','S066'),('P014','S067'),('P003','S088'),('P005','S088');
...
INSERT INTO `Seller` VALUES ('S001','BIC','5'),('S002','CocaCola','5'),('S003','Edu','2'),('S004','Yomo','4'),('S005','Lavazza','4'),('S006','Lobyoh','1'),('S007','Orsen','2'),('S010','Hesense','4'),('S012','Disney ','5'),('S013','Zinus','3'),('S015','Huawei','4'),('S021','Barilla','5'),('S066','Apple','4'),('S067','Aloia','3'),('S088','Samsung','4');
/*!40000 ALTER TABLE `Seller` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `SpendingRange`
--

DROP TABLE IF EXISTS `SpendingRange`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SpendingRange` (
  ...
  `min_rqty` int DEFAULT NULL,
  `cost` float DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `SpendingrangeSeller_idx` (`code_seller`),
  CONSTRAINT `SpendingrangeSeller` FOREIGN KEY (`code_seller`) REFERENCES `Seller` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `SpendingRange`
--

LOCK TABLES `SpendingRange` WRITE;
/*!40000 ALTER TABLE `SpendingRange` DISABLE KEYS */;
INSERT INTO `SpendingRange` VALUES ('R001','S001',30,1,0),('R002','S001',100,31,2.99),('R003','S001',999,101,4.99),('R011','S002',2,1,1.99),('R012','S002',999,3,0),('R021','S003',999,1,2.99),('R031','S004',10,1,0.99),('R032','S004',20,11,0.49),('R033','S004',999,21,0),('R041','S005',1,1,0.99),('R042','S005',3,2,0.19),('R043','S005',999,4,0),('R051','S006',4,1,4.99),('R052','S006',7,5,3.99),('R053','S006',9,8,2.99),('R054','S006',15,10,1.99),('R055','S006',30,16,0.99),('R056','S006',100,31,0.45),('R057','S006',999,100,0.01),('R061','S007',9,1,0.99),('R062','S007',999,10,0),('R111','S010',999,1,0),('R131','S012',999,1,0.49),('R141','S013',999,1,0),('R161','S015',999,1,0),('R221','S021',5,1,0.99),('R222','S021',999,6,0),('R671','S066',999,1,0),('R681','S067',4,1,9.99),('R682','S067',9,5,5.99),('R683','S067',20,10,2.99),('R684','S067',50,21,0.99),('R891','S088',999,1,0);
/*!40000 ALTER TABLE `SpendingRange` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `User` VALUES ('ken@mail.com','Ken','Chen','via web100','123','ken','2000-01-01'),('leo@mail.com','Yanghao','Mao','via web100','123','leo','1999-10-31');
/*!40000 ALTER TABLE `User` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'Web100'
--

--
-- Dumping routines for database 'Web100'
--
...
-- Dump completed on 2023-04-19  0:03:50
